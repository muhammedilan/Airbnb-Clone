    ...
    <>
      ...
      >
        ...
        >
          ...
          <button className="p-[10px] mr-[7px] flex-shrink-0 bg-primary text-white rounded-full hover:shadow-hover">
        ...
        >
          ...
          <div className="w-[min(100%,850px)] flex items-center h-[66px] border border-[#dddddd] rounded-[32px]">
            {searchDropdownButtons.map((button, index) => (
              <>
                {index !== 0 && (
